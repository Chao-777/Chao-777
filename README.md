# Hi, I'm Nic (Chao Yuan) 👋

🎓 Master of IT (Software Development) @ Griffith University  
...
I'm a full-stack developer with a strong focus on **cloud computing and scalable systems**.  
I enjoy building end-to-end applications — from UI to backend to deployment.
...
### Software Engineer Intern @ ApyApp
📍 Sydney | Mar 2025 – Jul 2025  
...
### 🖌 Haninkcalli (Tattoo Preview Platform)
🔗 http://haninkcalli.com  

- Full-stack **Next.js app with SEO & dynamic routing**  
- Real-time **3D tattoo preview using Three.js**  
- Export designs as **PNG/SVG (Canvas API)**  
- Deployed on **AWS (Amplify, Cognito, DynamoDB, CloudFront)**  
